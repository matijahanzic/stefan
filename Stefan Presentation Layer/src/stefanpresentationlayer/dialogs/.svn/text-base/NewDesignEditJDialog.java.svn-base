 ...
 * @author Robert
 */
public class NewDesignEditJDialog extends javax.swing.JDialog {
    ...
    public NewDesignEditJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public NewDesignEditJDialog(java.awt.Frame parent, boolean modal, Design selectedDesign) {
        super(parent, modal);
        initComponents();
        designDateInput.setDate(new Date());
        resultsPanel.setVisible(false);
        ...
        materials = manager.GetAll();
        this.firePropertyChange("materials", null, null);
        setTitle("Izmjena Nacrta");
        designNumberInput.setText(selectedDesign.getDesignNumber());
        designNameInput.setText(selectedDesign.getName());
        designIdInput.setText(selectedDesign.getDesignIdentity());
        designClassInput.setText(selectedDesign.getClassMark());
        selDesign = selectedDesign;
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stefanpresentationlayer.StefanPresentationLayerApp.class).getContext().getResourceMap(NewDesignEditJDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(stefanpresentationlayer.StefanPresentationLayerApp.class).getContext().getActionMap(NewDesignEditJDialog.class, this);
        ...
        povecanjeCijene.setText(resourceMap.getString("povecanjeCijene.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewDesignEditJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                NewDesignEditJDialog dialog = new NewDesignEditJDialog(new javax.swing.JFrame(), true);
    ...
    public void SaveDesign() {
        if (!CheckInputField()) {
            ...
            try {
                ...
                selDesign.setDate(designDateInput.getDate());
                selDesign.setClassMark(designClassInput.getText().trim().toString());
                selDesign.setDesignNumber(designNumberInput.getText().trim().toString());
                selDesign.setMaterialId(selectedMaterial.getIdShape());
                selDesign.setName(designNameInput.getText().trim().toString());
                selDesign.setDesignIdentity(designIdInput.getText().trim().toString());
                //prices for each pcs
                if (selectedMaterial.getMaterialDetails().getNiklanje()) {
                    GetDesignPrices(selDesign, 3,form);

                } else {
                    GetDesignPrices(selDesign, 2,form);
                }

                DesignManager manager = new DesignManager();
                manager.ChangeDesign(selDesign);
                this.dispose();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Problem pri editiranju nacrta. " + e);
                return;
            }
        }
    }
