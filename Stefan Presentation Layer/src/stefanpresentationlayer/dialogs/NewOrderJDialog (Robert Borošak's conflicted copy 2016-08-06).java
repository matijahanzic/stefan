...
public class NewOrderJDialog extends javax.swing.JDialog implements TableModelListener {
    ...
    private void initComponents() {
        ...
        MaterialsTable.getColumnModel().getColumn(5).setHeaderValue(resourceMap.getString("MaterialsTable.columnModel.title5")); // NOI18N
        MaterialsTable.getColumnModel().getColumn(6).setHeaderValue(resourceMap.getString("MaterialsTable.columnModel.title6")); // NOI18N
        MaterialsTable.getColumnModel().getColumn(7).setHeaderValue(resourceMap.getString("MaterialsTable.columnModel.title7")); // NOI18N
        MaterialsTable.getColumnModel().getColumn(8).setHeaderValue(resourceMap.getString("MaterialsTable.columnModel.title8")); // NOI18N
